...
- [zendframework/zend-expressive-twigrenderer#59](https://github.com/zendframework/zend-expressive-twigrenderer/pull/57) adds Environment configuration options for 'cache', 'debug' and 'strict_variables'.
